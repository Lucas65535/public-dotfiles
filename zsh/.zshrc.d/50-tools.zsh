...
if [[ "$_theme_mode" == "light" ]]; then
  ...
  ZSH_HIGHLIGHT_STYLES[comment]='fg=#6B665F,italic'
  ZSH_HIGHLIGHT_STYLES[pipeline]='fg=#AFCCF8,bold'
  ZSH_HIGHLIGHT_STYLES[command]='fg=#AFCCF8,bold'
  ZSH_HIGHLIGHT_STYLES[alias]='fg=#BDA8CF,bold'
  ZSH_HIGHLIGHT_STYLES[function]='fg=#8CC4FF,bold'
  ZSH_HIGHLIGHT_STYLES[builtin]='fg=#D4967E,bold'
  ZSH_HIGHLIGHT_STYLES[precommand]='fg=#D4967E'
  ZSH_HIGHLIGHT_STYLES[keyword]='fg=#BDA8CF'
  ZSH_HIGHLIGHT_STYLES[string]='fg=#B5E6A0'
  ZSH_HIGHLIGHT_STYLES[bracket]='fg=#8CC4FF'
  ZSH_HIGHLIGHT_STYLES[commandseparator]='fg=#C6BDB2'
  ZSH_HIGHLIGHT_STYLES[redirection]='fg=#D4967E'
  ZSH_HIGHLIGHT_STYLES[arg0]='fg=#EAE7DF'
  ZSH_HIGHLIGHT_STYLES[path]='fg=#B5E6A0,underline'
  ZSH_HIGHLIGHT_STYLES[path_pathseparator]='fg=#BDA8CF'
  ZSH_HIGHLIGHT_STYLES[path_prefix]='fg=#EAE7DF'
  ZSH_HIGHLIGHT_STYLES[path_prefix_separator]='fg=#BDA8CF'
  ZSH_HIGHLIGHT_STYLES[globbing]='fg=#BDA8CF'
  ZSH_HIGHLIGHT_STYLES[history-expansion]='fg=#BDA8CF'
  ...
  ZSH_HIGHLIGHT_STYLES[rc-quote]='fg=#B5E6A0'
  ...
  ZSH_HIGHLIGHT_STYLES[assign]='fg=#D4967E'
  ZSH_HIGHLIGHT_STYLES[named-fd]='fg=#D4967E'
  ZSH_HIGHLIGHT_STYLES[numeric-fd]='fg=#D4967E'
  ZSH_HIGHLIGHT_STYLES[unknown-token]='fg=#F09884,bold'
  ZSH_HIGHLIGHT_STYLES[unknown-command]='fg=#F09884,bold'
  ZSH_HIGHLIGHT_STYLES[reserved-word]='fg=#BDA8CF'
  ZSH_HIGHLIGHT_STYLES[suffix-alias]='fg=#BDA8CF'
  ZSH_HIGHLIGHT_STYLES[global-alias]='fg=#BDA8CF'
